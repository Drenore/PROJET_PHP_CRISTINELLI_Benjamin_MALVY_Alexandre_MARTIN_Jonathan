<!-- Affichage du Header en haut de page mais pas importer ici car il ne faut pas avoir accès à l'acceuil -->
<?php
  $titre = "Inscription";
  $description = "Page d'inscription de notre site web";

  // Requête SQL :
  // INSERT INTO utilisateur (id, 'user_name', 'user_email', 'user_password') VALUES ($id, $username, $email, $password)
