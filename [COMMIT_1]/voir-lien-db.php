...
<?php
    ...
    $description = "Cette page permet de voir tous les liens recherchés stockés dans la base de données local";
...
<section class="section active">
    <h1 class="is-size-2"><strong>Viusalisation de liens déjà recherchés et le nombre de clics</strong></h1>
    <form method="POST">
        <p>
